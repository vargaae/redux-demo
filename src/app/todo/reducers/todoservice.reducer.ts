...
// export interface TodoServiceAppState {
//   // todos: any[];
//   // lastUpdate: Date;
//   // title: string;
// }

// export const initialState: TodoServiceAppState = {
  // todos: [],
  // lastUpdate: null
// }
...
/// Reducer function
// export function todoServiceReducer(state: TodoServiceAppState = initialState, action) {
